...
class FinancialModelTestCalcs(unittest.TestCase):
    def test_closest_date(self):
        ...
        correct_closest_date = datetime.datetime.strptime(
            correct_closest_date, "%Y-%m-%d"
        ).date()
    ...
    def test_extract_subsection(self):
        ...
        (
            ...
            fist_index,
            end_index,
        ) = test_asset.extract_subsection(start_date, end_date)
        sub_section_array = [
            value_sub_section,
            close_sub_section,
            open_sub_section,
    ...
    def test_CAPM(self):
        ...
        date = datetime.datetime.strptime(date, "%Y-%m-%d").date()
        # calculate the CAPM
        expected_return = test_asset.calculate_CAPM(
            macro_economic_factors, date, hyperparameters["CAPM_period"]
        )
    ...
    def test_illiquidity_ratio(self):
        ...
        illiquidity_ratio = test_asset.calculate_illiquidity_ratio(
            date, hyperparameters["illiquidity_ratio_period"]
        )
